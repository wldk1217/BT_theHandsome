...
var searchAddrLayer = function(addr1, addr2, zipcode){
    ...
    var addressLayerTag = '<div class="popwrap w_type_3"  style="z-index:150">                                                                             ' ;
        ...
        addressLayerTag += '    </div>                                                                                                ' ;
        addressLayerTag += '    <!--//contents-->                                                                                     ' ;
        addressLayerTag += '    <a href="javascript:void(0);" class="btn_close"><img src="/resources/_ui/desktop/common/images/popup/ico_close.png" alt="닫기"></a>';
        addressLayerTag += '</div>';
...
var searchAddressLayer = function(addr1, addr2, zipcode){
    ...
    var addressLayerTag = '<div class="popwrap w_type_3 zipcodepop1904">                                       ' ;
        ...
        addressLayerTag += '        </div>                                                                                            ' ;
        addressLayerTag += '    </div>                                                                                                ' ;
        addressLayerTag += '    <a href="#;" class="btn_close"><img src="/resources/_ui/desktop/common/images/popup/ico_close.png" alt="닫기"></a>';
        addressLayerTag += '</div>';
