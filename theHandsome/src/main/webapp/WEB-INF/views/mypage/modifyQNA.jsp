<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%> <%@ include file="/WEB-INF/views/common/header.jsp"%>
 <!-- 
 /* 
 * 작성자 : 고정민
 * 
...
<script>
    $(document).ready(function () {
        ...
        else $("input[name=qid]").attr("value", "${qnaAttribute.qid }");
        $("#registerBtn").click(function () {
            $("#manToManInquiryForm").attr("action", "/mypage/modifyQNA");
...
<div id="bodyWrap">
    ...
    <div class="sub_container clearfix">
        ...
        <div class="sub_cnts">
            ...
            <form id="manToManInquiryForm" name="manToManInquiryForm" action="/ko/svcenter/mantomaninquiry?refererUrl=" method="post">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" id="qtitle" name="qtitle" value="${qnaAttribute.qtitle }" title="문의제목" class="w_all" />
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row"><strong class="reqd">*</strong>문의 내용<span class="com_txt_p">(2000자 이하)</span></th>
                                    <td>
                                        <!-- textarea -->
                                        <textarea id="qcontent" name="qcontent" title="문의내용" cols="30" rows="10">${qnaAttribute.qcontent }</textarea>
                                        <!-- //textarea -->
                                    </td>
                                </tr>
                                <!-- popup end -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- //hp -->
                                        <!-- check -->
                                        <span class="wtype_comment pt10"> <input type="checkbox" id="smsAlarmReceiveYN" name="smsAlarmReceiveYN" class="mr5" /><label for="ck1">SMS 알람고지</label> </span>
                                        <!-- //check -->
                                    </td>
                                </tr>
                                <tr>
            ...
            <ul class="bul_sty01_li mt60">
                <li>
                    문의하신 내용에 대한 답변은 이메일 또는 <a href="/ko/mypage/mymantomaninquiry"><em class="ft_point01">마이페이지 &gt; 1:1 문의내역</em></a>에서 확인하실 수 있습니다.
                </li>
