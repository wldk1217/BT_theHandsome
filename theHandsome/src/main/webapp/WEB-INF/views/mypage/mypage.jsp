    ...
    <div class="sub_container">
        ...
        <div class="lnb_wrap">
            ...
            <div class="lnb">
                <dl>
                    <dt>주문조회</dt>
                    <dd>
                        <a href="/mypage/order/myorders" onclick="GA_Event('마이페이지','LNB','주문/배송/반품/취소');">주문/배송/반품/취소</a>
                    </dd>
                </dl>
                <dl>
                    <dt>혜택관리</dt>
                    <dd>
                        <a href="/mypage/myGradeInfo" onclick="GA_Event('마이페이지','LNB','나의 회원 등급');">나의 회원 등급</a>
                    </dd>
                    <dd>
                        <a href="/mypage/voucher" onclick="GA_Event('마이페이지','LNB','나의 쿠폰');">나의 쿠폰<!-- 쿠폰함 --></a>
                    </dd>
                    <dd>
                        <a href="/mypage/mypoint" onclick="GA_Event('마이페이지','LNB','나의 한섬마일리지');">나의 한섬마일리지</a>
                    </dd>
                    <dd>
                        <a href="/mypage/myEGiftCard" onclick="GA_Event('마이페이지','LNB','E-GIFT CARD');">e-Gift Card</a>
                    </dd>
                </dl>
                <dl>
                    <dt>나의 상품관리</dt>
                    <dd>
                        <a href="/mypage/myWish" onclick="GA_Event('마이페이지','LNB','위시리스트');">위시리스트<!-- 위시리스트 --></a>
                    </dd>
                    <dd>
                        <a href="/mypage/rsalarm" onclick="GA_Event('마이페이지','LNB','재입고 알림');">재입고 알림<!-- 재입고알림 --></a>
                    </dd>
                </dl>
                <dl>
                    <dt>나의 정보관리</dt>
                    ...
                    <dd>
                        <a href="/mypage/shoppingAddressPWCheck" onclick="GA_Event('마이페이지','LNB','배송지 관리');">배송지 관리</a>
                    </dd>
                    <dd>
                        <a href="/mypage/oneClick" onclick="GA_Event('마이페이지','LNB','원클릭 결제 관리');">원클릭 결제 관리</a>
                    </dd>
                    <dd>
                        <a href="/mypage/mergeCustomerInfo" onclick="GA_Event('마이페이지','LNB','한섬 멤버십 통합');">한섬 멤버십 통합</a>
                    </dd>
                </dl>
                <dl>
                    <dt>나의 활동관리</dt>
                    <!-- <dd><a href="#">회원등급</a></dd> -->
                    <dd>
                        <a href="/mypage/myreview" onclick="GA_Event('마이페이지','LNB','내 상품평');">내 상품평</a>
                    </dd>
                    <dd>
                        <a href="/mypage/myqna" onclick="GA_Event('마이페이지','LNB','상품 Q&A');">상품 Q&A</a>
                    </dd>
                    <dd>
                        <a href="/mypage/mymantomaninquiry" onclick="GA_Event('마이페이지','LNB','1:1 문의');">1:1 문의</a>
                    </dd>
        ...
        <div class="sub_cnts">
                ...
                <div class="pointbox_cover">
                    <div class="point_wrap">
                        <div class="point" style="border-left: 0; padding-left: 0;">
                            ...
                            <a class="count" href="/mypage/mypoint" onclick="GA_Event('마이페이지','회원정보','한섬마일리지');">0&nbsp;<span>M</span></a>
                        </div>
                        <div class="point">
                        ...
                        <div class="point">
                            ...
                            <a class="count" href="/mypage/mygiftcard" onclick="GA_Event('마이페이지','회원정보','GIFT CARD');">0&nbsp;<span>원</span></a>
                        </div>
                        <div class="point">
                            <p class="title">e-money</p>
                            <a class="count" href="/mypage/myEGiftCard" onclick="GA_Event('마이페이지','회원정보','E-MONEY');">0&nbsp;<span>원</span></a>
                        </div>
                        <div class="point">
                            <p class="title">COUPON</p>
                            <a class="count" href="/mypage/voucher" onclick="GA_Event('마이페이지','회원정보','COUPON');">5&nbsp;<span>장</span></a>
                        </div>
            ...
            <div class="title_wrap">
                ...
                <div class="btn_wrap">
                    <a href="/mypage/order/myorders" class="btn add_ss" onclick="GA_Event('마이페이지','최근주문','전체보기');">전체보기<!-- 전체보기 --></a>
                </div>
            </div>
            <!-- table -->
